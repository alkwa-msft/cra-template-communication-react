 ...
 * @public
 */
export declare type FunctionWithKey<KeyT, ArgsT extends unknown[], RetT> = (key: KeyT, ...args: ArgsT) => RetT;
/**
 * A function type that is called with the result of a memoized functions return value.
 *
 * @public
 */
export declare type CallbackType<KeyT, ArgsT extends unknown[], FnRetT> = (memoizedFn: FunctionWithKey<KeyT, ArgsT, FnRetT>) => FnRetT[];
/**
