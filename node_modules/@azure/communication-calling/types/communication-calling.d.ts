...
declare type CallInformationContext = 'transferToParticipant' | 'transferToCall' | 'escalation' | 'roomJoin' | 'groupJoin' | 'teamsMeetingJoin' | '';

declare type CallInformationIdentifierKind = 'microsoftTeamsUser' | 'phoneNumber' | 'communicationUser' | 'unknown';

declare type CallInformationScenario = 'P2P' | 'Multiparty' | 'Unknown';
...
export declare class LocalVideoStream {
    ...
    private setSource;
    private sendLocalVideoStreamEvent;
    private mediaStreamPayload;
    private sendMediaStreamEvent;
 ...
 * Media stream type.
 */
export declare type MediaStreamType = 'Video' | 'ScreenSharing' | 'LiveStream' | 'RawMedia';
