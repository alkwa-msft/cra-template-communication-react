...
var createFelaRenderer = function () {
    var felaRenderer = fela_1.createRenderer(rendererConfig);
    var usedRenderers = 0;
    // rehydration disabled to avoid leaking styles between renderers
    // https://github.com/rofrischmann/fela/blob/master/docs/api/fela-dom/rehydrate.md
    var Provider = function (props) { return (React.createElement(react_fela_1.RendererProvider, __assign({ renderer: felaRenderer }, { rehydrate: false, targetDocument: props.target }), props.children)); };
    return {
        ...
        renderRule: function (styles, param) {
            var felaParam = __assign(__assign({}, param), { theme: { direction: param.direction } });
