...
var FocusZone = /** @class */ (function (_super) {
    ...
    function FocusZone(props) {
        ...
        _this.setRef = function (elem) {
            ...
            react_component_ref_1.handleRef(_this.props.innerRef, elem);
            if (process.env.NODE_ENV !== 'production') {
                if (elem !== null && !((elem === null || elem === void 0 ? void 0 : elem.nodeType) === 1)) {
    ...
    FocusZone.prototype.render = function () {
        ...
        return (React.createElement(ElementType, __assign({}, unhandledProps, { ref: this.setRef, className: classnames_1.default(FocusZone.className, className), "data-focuszone-id": this._id, onKeyDown: this._onKeyDown, onFocus: this._onFocus, onMouseDownCapture: this._onMouseDown }), this.props.children));
    };
    /**
     ...
     */
    FocusZone.prototype.tryInvokeClickForFocusable = function (targetElement, ev) {
