...
describe('Menu', function () {
    commonTests_1.isConformant(Menu_1.Menu, {
        testPath: __filename,
    ...
    describe('items', function () {
        ...
        describe('itemsCount and itemPosition', function () {
            ...
            it('should not be set on the divider', function () {
                var wrapper = utils_1.mountWithProvider(React.createElement(Menu_1.Menu, { items: __spreadArray(__spreadArray([], getItems()), [{ kind: 'divider', key: 'divider' }]) }));
