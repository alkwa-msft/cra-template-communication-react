    ...
    var getItems = function () { return [
        {
            ...
            active: bold,
            icon: React.createElement(react_icons_northstar_1.BoldIcon, __assign({}, { outline: true })),
            title: 'Toggle bold',
        ...
        },
        {
            accessibility: accessibility_1.toggleButtonBehavior,
            active: italic,
            icon: React.createElement(react_icons_northstar_1.ItalicIcon, __assign({}, { outline: true })),
            title: 'Toggle italic',
