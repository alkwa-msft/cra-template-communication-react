...
exports.toolbarItemStyles = {
    root: function (_a) {
        ...
        return __assign(__assign(__assign(__assign({ position: 'relative', backgroundColor: v.background, borderWidth: borderWidth, borderStyle: 'solid', borderColor: 'transparent', borderRadius: v.borderRadius, height: v.itemHeight, minWidth: v.itemHeight, padding: v.itemPadding, color: v.foreground || colors.foreground1, cursor: 'pointer', userSelect: 'none', ':focus': borderFocusStyles[':focus'] }, (p.active && __assign({ color: v.foregroundActive || colors.foregroundActive, backgroundColor: v.backgroundActive }, getIconFillOrOutlineStyles_1.getIconFillOrOutlineStyles({ outline: false })))), { ':hover': __assign({ color: v.foregroundHover || colors.foregroundHover, backgroundColor: v.backgroundHover || colors.backgroundHover }, getIconFillOrOutlineStyles_1.getIconFillOrOutlineStyles({ outline: false })), ':focus-visible': borderFocusStyles[':focus-visible'] }), ((p.disabled || p.disabledFocusable) && {
