...
var keysAndAliases = __assign(__assign({}, accessibility_1.keyboardKey), { Spacebar: accessibility_1.SpacebarKey });
...
exports.definitions.push({
    ...
    testMethod: function (parameters) {
        var roleToBeAdded = __spreadArray([], parameters.props)[0];
        var property = {};
...
exports.definitions.push({
    ...
    testMethod: function (parameters) {
        var _a = __spreadArray([], parameters.props), action = _a[0], firstKey = _a[1], secondKey = _a[2], elementToPerformAction = _a[3];
        var property = {};
...
exports.definitions.push({
    ...
    testMethod: function (parameters) {
        var _a = __spreadArray([], parameters.props), action = _a[0], key = _a[1], elementToPerformAction = _a[2];
        var property = {};
...
exports.definitions.push({
    ...
    testMethod: function (parameters) {
        var _a = __spreadArray([], parameters.props), action = _a[0], key = _a[1], elementToPerformAction = _a[2], propertyDependingOn = _a[3];
        var propsInOpenState = {};
        propsInOpenState[propertyDependingOn] = true;
        var expectedResultOpenState = parameters.behavior(propsInOpenState).keyActions[elementToPerformAction][action]
            .keyCombinations[0].keyCode;
        expect(expectedResultOpenState).toBe(keysAndAliases[key]);
        var propsInCloseState = {};
        propsInCloseState[propertyDependingOn] = false;
        var expectedResultCloseState = parameters.behavior(propsInCloseState).keyActions[elementToPerformAction][action];
...
exports.definitions.push({
    ...
    testMethod: function (parameters) {
        var _a = __spreadArray([], parameters.props), action = _a[0], keyModifier = _a[1], key = _a[2], elementToPerformAction = _a[3];
        var property = {};
